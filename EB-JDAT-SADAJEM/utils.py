...
# cifar10_mirror_url = "https://mirrors.aliyun.com/cs/cifar-10-python.tar.gz"
...
def dataset_fn(args, train, transform):
    if args.dataset == "cifar10":
        ...
        return cls(root=args.data_root, transform=transform, download=False, train=train)
...
def import_data(data_type, use_train=True, use_random_transform=False):
    ...
    if data_type == 'cifar10':
        data = tv.datasets.CIFAR10(root='./data/cifar10', transform=transform, train=use_train, download=True)
        num_classes = 10
