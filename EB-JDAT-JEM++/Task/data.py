...
class TFImagenetLoader(Dataset):
    ...
    def __init__(self, split, batchsize, idx, num_workers, rescale=1):
        ...
        ds = ds.apply(tf.data.Dataset.map_and_batch(map_func=preprocess_function, batch_size=FLAGS.batch_size, num_parallel_batches=4))
...
class CelebA(Dataset):
    ...
    def __getitem__(self, index):
        ...
        img_resized = img.resize((32,32))  # 调整图像大小
        # im = imread(path)
